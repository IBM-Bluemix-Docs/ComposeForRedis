...
## Creazione di un'istanza del servizio {{site.data.keyword.composeForRedis}}
...
È presente un menu a discesa per selezionare la codifica TLS/SSL. La codifica è impostata su **True** per impostazione predefinita. Se selezioni **False** il servizio eseguirà il provisioning senza la codifica. Questo può essere utilizzato quando i tuoi driver non gestiscono la codifica e sei consapevole dei potenziali rischi del traffico non codificato. 
