...
アプリケーションを {{site.data.keyword.cloud_notm}} にプッシュする前に、ローカル環境でアプリケーションを実行して {{site.data.keyword.composeForRedis}} サービス・インスタンスへの接続をテストできます。サービスに接続するには、一連のサービス資格情報を作成する必要があります。
...
## ステップ 10: アプリケーションが {{site.data.keyword.composeForRedis}} サービスに接続していることを確認する
