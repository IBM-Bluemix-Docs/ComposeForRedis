...
Estas características le permiten adaptar el servicio {{site.data.keyword.composeForRedis_full}} para que se ajuste mejor a sus necesidades y requisitos.
...
![El panel Versión](./images/redis-version-show.png "El panel Versión")
