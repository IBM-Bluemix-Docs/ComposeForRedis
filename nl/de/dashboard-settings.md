...
Mit diesen Funktionen können Sie Ihren {{site.data.keyword.composeForRedis_full}}-Service besser an Ihre Bedürfnisse und Anforderungen anpassen.
...
![Versionsanzeige](./images/redis-version-show.png "Versionsanzeige")
...
2. Klicken Sie in der Anzeige _Bereitstellungsdetails_ auf **Ressourcen skalieren**. Die Seite 'Ressourcen skalieren' wird geöffnet. ![Seite 'Ressourcen skalieren'](./images/redis-scale-show.png "Seite 'Ressourcen skalieren'")
3. Passen Sie den Schieberegler an, um den Speicher zu erhöhen oder zu verringern, der dem {{site.data.keyword.composeForRedis}}-Service zugeordnet ist. Verschieben Sie den Schieberegler nach links, um den Speicherplatz zu verringern, oder nach rechts, um ihn zu erhöhen.
...
![Kennwort für Redis aktualisieren](./images/redis-update-password.png "Automatischer Kennwortgenerator")
...
![IP-Adressen auf Whitelist setzen](./images/redis-whitelist-show.png "Felder der Whitelist.")
