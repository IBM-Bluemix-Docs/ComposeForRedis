...
![Update password job running](./images/redis-update-password-running.png "The Deployment Details pane, showing one running job: Change Redis password running")
